...
- (void)loadView {
    ...
    self.awesomeToolbar                   = [[AwesomeFloatingToolbar alloc]
...
- (void)updateButtonsAndTitle {
    ...
    [self.awesomeToolbar setEnabled: [self.webView canGoBack]
                 forButtonWithTitle:kWebBrowserBackString];
    [self.awesomeToolbar setEnabled: [self.webView canGoForward]
                 forButtonWithTitle:kWebBrowserForwardString];
    [self.awesomeToolbar setEnabled: [self.webView isLoading]
                 forButtonWithTitle:kWebBrowserStopString];
    [self.awesomeToolbar setEnabled:![self.webView isLoading] && self.webView.URL
                 forButtonWithTitle:kWebBrowserRefreshString];
}
...
- (void)resetWebView {
    ...
    // Put the toolbar back on top of the webView.
    // Otherwise, the toolbar is hidden.
